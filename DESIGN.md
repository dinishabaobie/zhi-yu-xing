...
首屏使用约 0.82:1.18 的非对称两栏，左侧是宣言和行动，右侧是 3:2 四联摄影；间距随视口在 34–84px 之间变化。首页板块区采用 12 栏索引：游戏跨 7 栏，工作占右侧 4 栏并下移，知识从第二栏延伸至倒数第二栏，并以逻辑与科学双联摄影表达内部结构。板块页首屏使用大标题与“当前收录”双栏，专题列表继续使用不对称 12 栏。写作区和关于区都使用不等分双栏，强调编辑节奏而非等宽卡片阵列。
